...
city_entry = Entry(root, padx=10, pady=10)
city_entry.pack()

get_weather_button = Button(root, text="Obter clima", command=update_weather, padx=10, pady=10)
get_weather_button.pack()

weather_text = Text(root, height=5, padx=10, pady=10)
weather_text.pack()
